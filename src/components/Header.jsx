...
const Header = () => {
  ...
  return (
    <div className='flex flex-col items-center mt-20 px-4 text-center text-gray-800'>
        ...
        <p className='mb-8 max-w-md'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Assumenda omnis ipsa quas, nulla similique fugit perferendis quo incidunt reprehenderit ut, laboriosam voluptate. 
            Numquam beatae facere nobis accusamus molestias omnis itaque!</p>
