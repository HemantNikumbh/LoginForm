...
const EmailVerify = () => {
  ...
  const{backendUrl,isLoggein,userData,getUserData} = useContext(AppContext)
  
  const inputRefs = useRef([]) 

  //Automatically move otp block when insert otp
  ...
  useEffect(()=>{
    isLoggein && userData && userData.isAccountVerified && navigate("/")
